...
ENV PYTHONDONTWRITEBYTECODE=1 PYTHONUNBUFFERED=1 PYTHONPATH=/app/src \
    DEMO_DATABASE_PATH=/data/chroma OLLAMA_BASE_URL=http://host.docker.internal:11434
WORKDIR /app
...
COPY docs docs
COPY src src
RUN useradd --create-home app && mkdir -p /data/chroma /home/app/.cache/huggingface && chown -R app:app /data /home/app
USER app
EXPOSE 8000
